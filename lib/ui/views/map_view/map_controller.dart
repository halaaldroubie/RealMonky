...
import 'package:food_ordering_sp1/core/data/models/apis/countries_model.dart';
import 'package:food_ordering_sp1/core/services/base_controller.dart';
import 'package:food_ordering_sp1/core/utils/map_util.dart';
...
class MapController extends BaseController {
  ...
  List<countriesModel> resultList = [];
  ...
  void onInit() {
    ...
    selectedLocation = LatLng(currentLocation.latitude ?? 37.43296265331129,
        currentLocation.longitude ?? -122.08832357078792);
    countryjsonList.forEach((element) {
      resultList.add(countriesModel.fromJson(element));
    });
